...
def find_pdf_duplicates_route():
    ...
    try:
        ...
        print(f"Error in find_pdf_duplicates_route: {e}")
...
def find_docx_duplicates_route():
    ...
    try:
        ...
        print(f"Error in find_docx_duplicates_route: {e}")
        return jsonify({'message': 'An error occurred', 'error': str(e)}), 500
...
def find_text_duplicates_route():
    ...
    try:
        ...
        print(f"Error in find_text_duplicates_route: {e}")
        return jsonify({'message': 'An error occurred', 'error': str(e)}), 500
...
def find_any_duplicates_route():
    ...
    try:
        ...
        print(f"Error in find_any_duplicates_route: {e}")
        return jsonify({'message': 'An error occurred', 'error': str(e)}), 500
...
def find_similarity_route():
    ...
    try:
        ...
        print(f"Error in find_similarity_route: {e}")
        return jsonify({'message': 'An error occurred', 'error': str(e)}), 500
